...
import { Check, CalendarCheck, Coffee } from 'lucide-react'
          ...
          {STUDY_TASKS.map((t) => {
            ...
            return (
              <li key={t.id}>
                <button
                  onClick={() => toggle(t.id)}
                  className="flex w-full items-center gap-3 rounded-xl p-2 text-left transition-colors hover:bg-soft/60"
                >
                  <span
                    className={cn(
